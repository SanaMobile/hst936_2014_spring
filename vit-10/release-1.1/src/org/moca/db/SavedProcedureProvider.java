...
public class SavedProcedureProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        if(values.containsKey(SavedProcedureSQLFormat.GUID) == false) {
        	values.put(SavedProcedureSQLFormat.GUID, MocaUtil.randomString("SP",
        			20));
        }
    ...
    static {
        ...
        sUriMatcher.addURI(MocaDB.SAVED_PROCEDURE_AUTHORITY, "savedProcedures", SAVED_PROCEDURES);
        sUriMatcher.addURI(MocaDB.SAVED_PROCEDURE_AUTHORITY, "savedProcedures/#", SAVED_PROCEDURE_ID);
