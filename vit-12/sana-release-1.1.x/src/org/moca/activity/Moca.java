...
public class Moca extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
        	setContentView(R.layout.main_devnagiri);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, OPTION_LANGUAGE, 3, getString(R.string.menu_marathi));
    	}
    	  else
          {   
              
          	menu.add(0, OPTION_RELOAD_DATABASE, 0, "परत लोड करा ");
              menu.add(0, OPTION_SETTINGS, 1, "सेटिंग्स ");
      		menu.add(0, OPTION_SYNC, 2, "सिंक्रनाइज़");
      		menu.add(0, OPTION_LANGUAGE, 3, "इंग्लिश ");
          }
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        case OPTION_RELOAD_DATABASE:
        	...
        	dialog.setMessage(getString(R.string.dialog_no_reload_db_warn));
            	...
            	if(lang==1)
            		dialog.setMessage("हे केल्या ने सर्व डाटा कोरा होइल  ");	
        	if(lang==0)
        	{
        	...
        	{dialog.setCancelable(true);
       	 dialog.setButton("हो", new OnClickListener() {
       		public void onClick(DialogInterface i, int v) {
       			doClearDatabase();
       		}
       	});
       	dialog.setButton2("नको", (OnClickListener)null);
       	dialog.show();
       	}
            return true;
