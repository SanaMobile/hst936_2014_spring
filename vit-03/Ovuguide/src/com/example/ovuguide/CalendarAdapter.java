...
public class CalendarAdapter extends BaseAdapter {
    ...
    public void refreshDays()
    {
    	...
    	int lastDay = month.getActualMaximum(Calendar.DAY_OF_MONTH);//gets last day of the current month
        int firstDay = (int)month.get(Calendar.DAY_OF_WEEK);//gets the day of the week the current date belongs to
