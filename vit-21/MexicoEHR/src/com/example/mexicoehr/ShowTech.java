...
public class ShowTech extends Activity implements OnClickListener {
	Button edit;
	...
	private static final String LOGIN_URL = "http://www.techcrunch.net.in/ehr/editlabrequest.php";
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ShowTech.this);
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(ShowTech.this, file_url, Toast.LENGTH_LONG)
						.show();
			}
