...
public class Nurse extends Activity implements OnClickListener {
	...
	private static final String LOGIN_URL = "http://www.techcrunch.net.in/ehr/login.php";
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Nurse.this);
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(Nurse.this, file_url, Toast.LENGTH_LONG).show();
			}
