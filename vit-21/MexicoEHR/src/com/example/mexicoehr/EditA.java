...
private static final String LOGIN_URL = "http://www.techcrunch.net.in/ehr/edita.php";
...
private static final String TAG_MESSAGE = "message";
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(EditA.this);
			pDialog.setMessage("Attempting edit...");
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				if (Licence.equals(JSONParser.getCurp())) {
					...
					Intent i = new Intent(getApplicationContext(), EditdetailsA.class);
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(EditA.this, file_url, Toast.LENGTH_LONG).show();
			}
