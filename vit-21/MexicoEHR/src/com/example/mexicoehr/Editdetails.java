...
public class Editdetails extends Activity implements OnClickListener,
	...
	private static final String LOGIN_URL = "http://www.techcrunch.net.in/ehr/editdetails.php";
	private static final String LOGIN_URL1 = "http://www.techcrunch.net.in/ehr/final1.php";
	private static final String LOGIN_URL5 = "http://www.techcrunch.net.in/ehr/final2.php";
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(Editdetails.this, file_url, Toast.LENGTH_LONG)
						.show();
			}
