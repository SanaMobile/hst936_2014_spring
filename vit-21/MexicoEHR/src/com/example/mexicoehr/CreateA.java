...
public class CreateA extends Activity implements OnClickListener,
	...
	private static final String LOGIN_URL = "http://www.techcrunch.net.in/ehr/adult.php";
...
fg=(TextView) findViewById(R.id.papa);
...
auto=(EditText)findViewById(R.id.autocomplete_country);
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(CreateA.this);
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(CreateA.this, file_url, Toast.LENGTH_LONG).show();
			}
