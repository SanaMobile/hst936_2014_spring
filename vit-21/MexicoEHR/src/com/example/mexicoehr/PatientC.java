...
public class PatientC extends Activity implements OnClickListener{
EditText licence;
...
private static final String LOGIN_URL = "http://www.techcrunch.net.in/ehr/doctorshow.php";
...
private static final String TAG_MESSAGE = "message";
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(PatientC.this);
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(PatientC.this, file_url, Toast.LENGTH_LONG).show();
			}
