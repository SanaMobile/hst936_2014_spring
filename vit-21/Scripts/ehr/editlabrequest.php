...
if (!empty($_POST)) {
    $query = " 
            UPDATE  children SET labresult1= :lb1,labresult2= :lb2,labresult3= :lb3,labresult4= :lb4,labresult5= :lb5  WHERE curp = :curp
			";
...
?>
		<h1>Login</h1> 
		<form action="editlabrequest.php" method="post"> 
		    CURP: 
