...
public class Doctor extends Activity implements OnClickListener {
	...
	private static final String LOGIN_URL = "http://www.techcrunch.net.in/ehr/doctorlogin.php";
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				if (success == 1) {
					...
					Intent i = new Intent(getApplicationContext(), DoctorEdit.class);
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(Doctor.this, file_url, Toast.LENGTH_LONG).show();
			}
