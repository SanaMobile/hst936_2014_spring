...
public class TechdetailsA extends Activity implements OnClickListener{
EditText licence;
...
private static final String LOGIN_URL = "http://www.techcrunch.net.in/ehr/techshowa.php";
...
private static final String TAG_MESSAGE = "message";
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(TechdetailsA.this);
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				if (Licence.equals(JSONParser.getCurp())) {
					...
					Intent i = new Intent(getApplicationContext(), ShowTechA.class);
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(TechdetailsA.this, file_url, Toast.LENGTH_LONG).show();
			}
