...
if (!empty($_POST)) {
    $query = " 
            UPDATE  adult SET temperature= :temp,weight= :weight,height= :height,waist_circumference= :waist,blood_pressure= :bp,pregnancy_status= :pregnancy,symptoms= :symptoms,notes= :notes,updated_on= :updatedon,updated_by= :updatedby, med1=:m1,med2= :m2, med3= :m3 WHERE curp = :curp
			";
