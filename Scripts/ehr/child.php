...
if (!empty($_POST)) {
	...
	$query = " 
            INSERT INTO children (curp,name,phone,email,relation,zip,colony,gender,cancer,diabetes,hypertension,created_by,created_on,clinic_name,dust,medicine,metals,food,animals,immunization,weight,height,waist_circumference,temperature,other,blood_pressure) VALUES (:curp , :name, :phone, :email, :relation, :zip, :colony, :gender, :cancer, :diabetes, :hypertension,:created_by,:created_on,  :cname , :dust,:med,:metal,:food,:animal,:imm,:weight,:height,:waist,:temp,:other,:bp)
			";
